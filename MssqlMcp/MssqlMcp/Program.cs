...
internal class Program
{
    ...
    {
        // Create the application host builder. The content root is pinned to the executable's
        // directory so appsettings.json is found regardless of the working directory the MCP
        // client happens to launch the server with.
